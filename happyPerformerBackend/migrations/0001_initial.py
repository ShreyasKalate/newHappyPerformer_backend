    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('P_Id', models.ForeignKey(db_column='P_Id', on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.employee')),
            ],
        ),
        migrations.CreateModel(
            name='clearance',
            fields=[
                ...
                ('employee_id', models.ForeignKey(db_column='P_Id', on_delete=django.db.models.deletion.CASCADE, related_name='clearances_requested', to='happyPerformerBackend.employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(db_column='P_Id', on_delete=django.db.models.deletion.CASCADE, related_name='created_cases', to='happyPerformerBackend.employee')),
            ],
        ),
        migrations.CreateModel(
            name='bank_details',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Investment6_Amount', models.IntegerField(default=0)),
                ('Emp_id', models.ForeignKey(db_column='Emp_id', on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.employee')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail', models.ForeignKey(db_column='emp_emailid', on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.employee')),
            ],
        ),
        migrations.CreateModel(
            name='poifiles_new',
            fields=[
                ...
                ('Emp_id', models.ForeignKey(db_column='emp_emailid', on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.employee')),
            ],
        ),
        migrations.CreateModel(
            name='qualification',
            fields=[
                ...
                ('P_Id', models.ForeignKey(db_column='emp_emailid', on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.employee')),
            ],
        ),
        migrations.CreateModel(
            name='resignation',
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['case_id'], name='chat_case_id_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['category_id'], name='chatbot_questions_category')],
            },
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['d_name', 'c_id'], name='department_d_name_c_id_idx'),
        ),
        migrations.AddIndex(
            model_name='department',
            index=models.Index(fields=['c_id'], name='department_c_id_idx'),
        ),
        migrations.AddIndex(
            model_name='employee',
            index=models.Index(fields=['d_id'], name='employee_d_id_idx'),
        ),
        migrations.AddIndex(
