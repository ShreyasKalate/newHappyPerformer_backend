    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_id', models.ForeignKey(db_column='course_id', default=None, on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.courses')),
                ('emp_emailid', models.ForeignKey(db_column='emp_emailid', default=None, on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.employee')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='case',
            name='created_by',
            field=models.ForeignKey(db_column='P_Id', on_delete=django.db.models.deletion.CASCADE, related_name='created_cases', to='happyPerformerBackend.employee'),
        ),
        migrations.CreateModel(
            name='Bank_details',
            fields=[
