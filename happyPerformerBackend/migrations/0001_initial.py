    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LeaveType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.leavetype')),
                ('emp_emailid', models.ForeignKey(default='abc@gmail.com', on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.employee')),
            ],
        ),
        migrations.CreateModel(
            name='Todotasks',
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['kra_id'], name='kra_kra_id_idx')],
            },
        ),
        migrations.CreateModel(
            name='Login',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail', models.ForeignKey(db_column='emp_emailid', default=None, on_delete=django.db.models.deletion.CASCADE, to='happyPerformerBackend.employee')),
            ],
            options={
                'indexes': [models.Index(fields=['mail'], name='happyPerfor_emp_ema_c8d10f_idx')],
            },
        ),
        migrations.CreateModel(
            name='Poifiles_new',
